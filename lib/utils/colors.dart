...
class ColorStrings{
  static const lightSkyBlue =  Color(0xFFD5EEFF) ;
  static const headingBlue =  Color(0xFF0A3C8E);
  static const havelockBlue =  Color(0xFFF1F7FD);
  // static const containerLabelGrey =  Color(9B979817);
  static const Color whiteColor = Color(0xFFFFFFFF);
  static const Color blackColor = Color(0xFF000000);
  // static const Color labelBlackColor = Color(0xFF040415);
